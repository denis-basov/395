...
<div class="row">
    <div class="col-lg-4 mb-4">
        <div class="entry2">
            <a href="single.php"><img src="images/img_1.jpg" alt="Image" class="img-fluid rounded" /></a>
            <div class="excerpt">
                <span class="post-category text-white bg-secondary mb-3">Politics</span>

                <h2><a href="single.php">The AI magically removes moving objects from videos.</a></h2>
                ...
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo sunt tempora dolor laudantium sed optio, explicabo ad deleniti impedit facilis fugit recusandae! Illo, aliquid, dicta
                    beatae quia porro id est.
                </p>
